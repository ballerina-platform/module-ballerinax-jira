...
public isolated client class Client {
    ...
    # + return - Returned if the request is successful 
    resource isolated function post api/'3/bulk/issues/delete(IssueBulkDeletePayload payload, map<string|string[]> headers = {}) returns SubmittedBulkOperation|error {
        string resourcePath = string `/api/3/bulk/issues/delete`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
        return self.clientEp->post(resourcePath, request, headers);
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/bulk/issues/transition(map<string|string[]> headers = {}, *GetAvailableTransitionsQueries queries) returns BulkTransitionGetAvailableTransitions|error {
        string resourcePath = string `/api/3/bulk/issues/transition`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + return - Returned if the request is successful 
    resource isolated function post api/'3/bulk/issues/transition(IssueBulkTransitionPayload payload, map<string|string[]> headers = {}) returns SubmittedBulkOperation|error {
        string resourcePath = string `/api/3/bulk/issues/transition`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + return - Returned if the request is successful 
    resource isolated function post api/'3/bulk/issues/unwatch(IssueBulkWatchOrUnwatchPayload payload, map<string|string[]> headers = {}) returns SubmittedBulkOperation|error {
        string resourcePath = string `/api/3/bulk/issues/unwatch`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
        return self.clientEp->post(resourcePath, request, headers);
    ...
    # + return - Returned if the request is successful 
    resource isolated function post api/'3/bulk/issues/watch(IssueBulkWatchOrUnwatchPayload payload, map<string|string[]> headers = {}) returns SubmittedBulkOperation|error {
        string resourcePath = string `/api/3/bulk/issues/watch`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
        return self.clientEp->post(resourcePath, request, headers);
    ...
    # + return - Returned if the request is successful 
    resource isolated function post api/'3/changelog/bulkfetch(BulkChangelogRequestBean payload, map<string|string[]> headers = {}) returns BulkChangelogResponseBean|error {
        string resourcePath = string `/api/3/changelog/bulkfetch`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
        return self.clientEp->post(resourcePath, request, headers);
    ...
    resource isolated function put api/'3/'field/association(FieldAssociationsRequest payload, map<string|string[]> headers = {}) returns json|error {
        string resourcePath = string `/api/3/field/association`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
        return self.clientEp->put(resourcePath, request, headers);
    ...
    # + return - Returned if the field association validation passes 
    resource isolated function delete api/'3/'field/association(FieldAssociationsRequest payload, map<string|string[]> headers = {}) returns json|error {
        string resourcePath = string `/api/3/field/association`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # # Deprecated
    @deprecated
    resource isolated function get api/'3/'field/[string fieldId]/contexts(map<string|string[]> headers = {}, *GetContextsForFieldDeprecatedQueries queries) returns PageBeanContext|error {
        string resourcePath = string `/api/3/field/${getEncodedUri(fieldId)}/contexts`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # # Deprecated
    @deprecated
    resource isolated function get api/'3/group(map<string|string[]> headers = {}, *GetGroupQueries queries) returns Group|error {
    ...
    # # Deprecated
    @deprecated
    resource isolated function get api/'3/issue/createmeta(map<string|string[]> headers = {}, *GetCreateIssueMetaQueries queries) returns IssueCreateMetadata|error {
        string resourcePath = string `/api/3/issue/createmeta`;
    ...
    # + headers - Headers to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function delete api/'3/issue/[string issueIdOrKey]/comment/[string id](map<string|string[]> headers = {}) returns error? {
        string resourcePath = string `/api/3/issue/${getEncodedUri(issueIdOrKey)}/comment/${getEncodedUri(id)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/jql/'function/computation(map<string|string[]> headers = {}, *GetPrecomputationsQueries queries) returns PageBean2JqlFunctionPrecomputationBean|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - 200 response 
    resource isolated function post api/'3/jql/'function/computation(JqlFunctionPrecomputationUpdateRequestBean payload, map<string|string[]> headers = {}, *UpdatePrecomputationsQueries queries) returns JqlFunctionPrecomputationUpdateResponse|json|error {
        string resourcePath = string `/api/3/jql/function/computation`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function post api/'3/jql/'function/computation/search(JqlFunctionPrecomputationGetByIdRequest payload, map<string|string[]> headers = {}, *GetPrecomputationsByIDQueries queries) returns JqlFunctionPrecomputationGetByIdResponse|error {
        string resourcePath = string `/api/3/jql/function/computation/search`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # # Deprecated
    @deprecated
    resource isolated function put api/'3/mypreferences/locale(Locale payload, map<string|string[]> headers = {}) returns json|error {
        string resourcePath = string `/api/3/mypreferences/locale`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/plans/plan(map<string|string[]> headers = {}, *GetPlansQueries queries) returns PageWithCursorGetPlanResponseForPage|error {
        string resourcePath = string `/api/3/plans/plan`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function post api/'3/plans/plan(CreatePlanRequest payload, map<string|string[]> headers = {}, *CreatePlanQueries queries) returns int|error {
        string resourcePath = string `/api/3/plans/plan`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/plans/plan/[int planId](map<string|string[]> headers = {}, *GetPlanQueries queries) returns GetPlanResponse|error {
        string resourcePath = string `/api/3/plans/plan/${getEncodedUri(planId)}`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function put api/'3/plans/plan/[int planId](record {} payload, map<string|string[]> headers = {}, *UpdatePlanQueries queries) returns json|error {
        string resourcePath = string `/api/3/plans/plan/${getEncodedUri(planId)}`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function put api/'3/plans/plan/[int planId]/archive(map<string|string[]> headers = {}) returns json|error {
        string resourcePath = string `/api/3/plans/plan/${getEncodedUri(planId)}/archive`;
        http:Request request = new;
        return self.clientEp->put(resourcePath, request, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function post api/'3/plans/plan/[int planId]/duplicate(DuplicatePlanRequest payload, map<string|string[]> headers = {}) returns int|error {
        string resourcePath = string `/api/3/plans/plan/${getEncodedUri(planId)}/duplicate`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
        return self.clientEp->post(resourcePath, request, headers);
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/plans/plan/[int planId]/team(map<string|string[]> headers = {}, *GetTeamsQueries queries) returns PageWithCursorGetTeamResponseForPage|error {
        string resourcePath = string `/api/3/plans/plan/${getEncodedUri(planId)}/team`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function post api/'3/plans/plan/[int planId]/team/atlassian(AddAtlassianTeamRequest payload, map<string|string[]> headers = {}) returns json|error {
        string resourcePath = string `/api/3/plans/plan/${getEncodedUri(planId)}/team/atlassian`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
        return self.clientEp->post(resourcePath, request, headers);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/plans/plan/[int planId]/team/atlassian/[string atlassianTeamId](map<string|string[]> headers = {}) returns GetAtlassianTeamResponse|error {
        string resourcePath = string `/api/3/plans/plan/${getEncodedUri(planId)}/team/atlassian/${getEncodedUri(atlassianTeamId)}`;
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function put api/'3/plans/plan/[int planId]/team/atlassian/[string atlassianTeamId](record {} payload, map<string|string[]> headers = {}) returns json|error {
        string resourcePath = string `/api/3/plans/plan/${getEncodedUri(planId)}/team/atlassian/${getEncodedUri(atlassianTeamId)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json-patch+json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function delete api/'3/plans/plan/[int planId]/team/atlassian/[string atlassianTeamId](map<string|string[]> headers = {}) returns json|error {
        string resourcePath = string `/api/3/plans/plan/${getEncodedUri(planId)}/team/atlassian/${getEncodedUri(atlassianTeamId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function post api/'3/plans/plan/[int planId]/team/planonly(CreatePlanOnlyTeamRequest payload, map<string|string[]> headers = {}) returns int|error {
        string resourcePath = string `/api/3/plans/plan/${getEncodedUri(planId)}/team/planonly`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
        return self.clientEp->post(resourcePath, request, headers);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/plans/plan/[int planId]/team/planonly/[int planOnlyTeamId](map<string|string[]> headers = {}) returns GetPlanOnlyTeamResponse|error {
        string resourcePath = string `/api/3/plans/plan/${getEncodedUri(planId)}/team/planonly/${getEncodedUri(planOnlyTeamId)}`;
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function put api/'3/plans/plan/[int planId]/team/planonly/[int planOnlyTeamId](record {} payload, map<string|string[]> headers = {}) returns json|error {
        string resourcePath = string `/api/3/plans/plan/${getEncodedUri(planId)}/team/planonly/${getEncodedUri(planOnlyTeamId)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json-patch+json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function delete api/'3/plans/plan/[int planId]/team/planonly/[int planOnlyTeamId](map<string|string[]> headers = {}) returns json|error {
        string resourcePath = string `/api/3/plans/plan/${getEncodedUri(planId)}/team/planonly/${getEncodedUri(planOnlyTeamId)}`;
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function put api/'3/plans/plan/[int planId]/trash(map<string|string[]> headers = {}) returns json|error {
        string resourcePath = string `/api/3/plans/plan/${getEncodedUri(planId)}/trash`;
        http:Request request = new;
        return self.clientEp->put(resourcePath, request, headers);
    }
    ...
    # # Deprecated
    @deprecated
    resource isolated function get api/'3/priority(map<string|string[]> headers = {}) returns Priority[]|error {
        string resourcePath = string `/api/3/priority`;
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # # Deprecated
    @deprecated
    resource isolated function post api/'3/priority(CreatePriorityDetails payload, map<string|string[]> headers = {}) returns PriorityId|error {
        string resourcePath = string `/api/3/priority`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # # Deprecated
    @deprecated
    resource isolated function get api/'3/priority/search(map<string|string[]> headers = {}, *SearchPrioritiesQueries queries) returns PageBeanPriority|error {
        string resourcePath = string `/api/3/priority/search`;
        map<Encoding> queryParamEncoding = {"id": {style: FORM, explode: true}, "projectId": {style: FORM, explode: true}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # # Deprecated
    @deprecated
    resource isolated function put api/'3/priority/[string id](UpdatePriorityDetails payload, map<string|string[]> headers = {}) returns json|error {
        string resourcePath = string `/api/3/priority/${getEncodedUri(id)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # # Deprecated
    @deprecated
    resource isolated function get api/'3/project(map<string|string[]> headers = {}, *GetAllProjectsQueries queries) returns Project[]|error {
    ...
    resource isolated function post api/'3/project\-template(ProjectCustomTemplateCreateRequestDTO payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/api/3/project-template`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
        return self.clientEp->post(resourcePath, request, headers);
    ...
    resource isolated function post api/'3/redact(BulkRedactionRequest payload, map<string|string[]> headers = {}) returns string|error {
        string resourcePath = string `/api/3/redact`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
        return self.clientEp->post(resourcePath, request, headers);
    ...
    resource isolated function get api/'3/redact/status/[string jobId](map<string|string[]> headers = {}) returns RedactionJobStatusResponse|error {
        string resourcePath = string `/api/3/redact/status/${getEncodedUri(jobId)}`;
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # # Deprecated
    @deprecated
    resource isolated function get api/'3/resolution(map<string|string[]> headers = {}) returns Resolution[]|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/search/jql(map<string|string[]> headers = {}, *SearchAndReconsileIssuesUsingJqlQueries queries) returns SearchAndReconcileResults|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/statuses/[string statusId]/project/[string projectId]/issueTypeUsages(map<string|string[]> headers = {}, *GetProjectIssueTypeUsagesForStatusQueries queries) returns StatusProjectIssueTypeUsageDTO|error {
        string resourcePath = string `/api/3/statuses/${getEncodedUri(statusId)}/project/${getEncodedUri(projectId)}/issueTypeUsages`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/statuses/[string statusId]/projectUsages(map<string|string[]> headers = {}, *GetProjectUsagesForStatusQueries queries) returns StatusProjectUsageDTO|error {
        string resourcePath = string `/api/3/statuses/${getEncodedUri(statusId)}/projectUsages`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/statuses/[string statusId]/workflowUsages(map<string|string[]> headers = {}, *GetWorkflowUsagesForStatusQueries queries) returns StatusWorkflowUsageDTO|error {
        string resourcePath = string `/api/3/statuses/${getEncodedUri(statusId)}/workflowUsages`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/user/nav4\-opt\-property/[string propertyKey](map<string|string[]> headers = {}, *GetUserNavPropertyQueries queries) returns UserNavPropertyJsonBean|error {
        string resourcePath = string `/api/3/user/nav4-opt-property/${getEncodedUri(propertyKey)}`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    resource isolated function put api/'3/user/nav4\-opt\-property/[string propertyKey](json payload, map<string|string[]> headers = {}, *SetUserNavPropertyQueries queries) returns json|error {
        string resourcePath = string `/api/3/user/nav4-opt-property/${getEncodedUri(propertyKey)}`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        http:Request request = new;
        request.setPayload(payload, "application/json");
    ...
    # # Deprecated
    @deprecated
    resource isolated function delete api/'3/version/[string id](map<string|string[]> headers = {}, *DeleteVersionQueries queries) returns error? {
        string resourcePath = string `/api/3/version/${getEncodedUri(id)}`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->delete(resourcePath, headers = headers);
    }
    ...
    # # Deprecated
    @deprecated
    resource isolated function get api/'3/workflow(map<string|string[]> headers = {}, *GetAllWorkflowsQueries queries) returns DeprecatedWorkflow[]|error {
        string resourcePath = string `/api/3/workflow`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # # Deprecated
    @deprecated
    resource isolated function post api/'3/workflow(CreateWorkflowDetails payload, map<string|string[]> headers = {}) returns WorkflowIDs|error {
        string resourcePath = string `/api/3/workflow`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/workflow/[string workflowId]/project/[int projectId]/issueTypeUsages(map<string|string[]> headers = {}, *GetWorkflowProjectIssueTypeUsagesQueries queries) returns WorkflowProjectIssueTypeUsageDTO|error {
        string resourcePath = string `/api/3/workflow/${getEncodedUri(workflowId)}/project/${getEncodedUri(projectId)}/issueTypeUsages`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/workflow/[string workflowId]/projectUsages(map<string|string[]> headers = {}, *GetProjectUsagesForWorkflowQueries queries) returns WorkflowProjectUsageDTO|error {
        string resourcePath = string `/api/3/workflow/${getEncodedUri(workflowId)}/projectUsages`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/workflow/[string workflowId]/workflowSchemes(map<string|string[]> headers = {}, *GetWorkflowSchemeUsagesForWorkflowQueries queries) returns WorkflowSchemeUsageDTO|error {
        string resourcePath = string `/api/3/workflow/${getEncodedUri(workflowId)}/workflowSchemes`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + headers - Headers to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/workflows/defaultEditor(map<string|string[]> headers = {}) returns DefaultWorkflowEditorResponse|error {
        string resourcePath = string `/api/3/workflows/defaultEditor`;
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/workflows/search(map<string|string[]> headers = {}, *SearchWorkflowsQueries queries) returns WorkflowSearchResponse|error {
        string resourcePath = string `/api/3/workflows/search`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
    ...
    # + queries - Queries to be sent with the request 
    # + return - Returned if the request is successful 
    resource isolated function get api/'3/workflowscheme/[string workflowSchemeId]/projectUsages(map<string|string[]> headers = {}, *GetProjectUsagesForWorkflowSchemeQueries queries) returns WorkflowSchemeProjectUsageDTO|error {
        string resourcePath = string `/api/3/workflowscheme/${getEncodedUri(workflowSchemeId)}/projectUsages`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        return self.clientEp->get(resourcePath, headers);
    }
